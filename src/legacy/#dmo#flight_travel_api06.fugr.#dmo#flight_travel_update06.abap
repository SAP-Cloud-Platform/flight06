...
*"        /DMO/IF_FLIGHT_LEGACY06=>TT_BOOKING_SUPPLEMENT_INX OPTIONAL
*"  EXPORTING
...
*"----------------------------------------------------------------------
  ...
  /dmo/cl_flight_legacy06=>get_instance( )->update_travel( EXPORTING is_travel              = is_travel
