...
INTERFACE /dmo/if_flight_legacy06
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL06
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel06     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING06
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking06    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_06
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_06 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT06
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight06 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id06.
  ...
  TYPES booking_id TYPE /dmo/booking_id06.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id06.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL06, /DMO/BOOKING06, /DMO/BOOK_SUP_06 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code06.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code06,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status06,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel06_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id06.
  INCLUDE TYPE /dmo/booking06_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id06.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id06.
  INCLUDE TYPE /dmo/book_sup_06_data.
