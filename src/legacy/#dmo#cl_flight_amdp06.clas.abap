CLASS /dmo/cl_flight_amdp06 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS convert_currency IMPORTING VALUE(iv_amount)               TYPE /dmo/total_price06
                                                  VALUE(iv_currency_code_source) TYPE /dmo/currency_code06
                                                  VALUE(iv_currency_code_target) TYPE /dmo/currency_code06
                                                  VALUE(iv_exchange_rate_date)   TYPE d
                                        EXPORTING VALUE(ev_amount)               TYPE /dmo/total_price06.
ENDCLASS.



CLASS /dmo/cl_flight_amdp06 IMPLEMENTATION.
